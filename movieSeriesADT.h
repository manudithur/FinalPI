...
void addContent (movieSeriesADT adt, int year, char * type, char * title, float rating, unsigned int votes, char ** genres, int * errorFlag);
...
int mostVotedMovie (movieSeriesADT movieSeries, char ** name, int * votes, float * rating, int * errorFlag);
//devuelve por parametros de salida el nombre, la cantidad de votos y el rating
//de la serie mas votada del currYear
int mostVotedSeries (movieSeriesADT movieSeries, char ** name, int * votes, float * rating, int * errorFlag);
